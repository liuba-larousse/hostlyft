...
import { Bot, Package, Users, Briefcase, ArrowRight, CalendarDays, BarChart3, Grid3X3 } from "lucide-react";
...
const quickLinks = [
  ...
  { href: "/dashboard/cloud9", icon: BarChart3, label: "Cloud 9", description: "Pricing actions and bookings matrix", color: "bg-indigo-50 text-indigo-600" },
  { href: "/dashboard/price-matrix", icon: Grid3X3, label: "Price Matrix", description: "Base, min, max pricing calculator", color: "bg-rose-50 text-rose-600" },
];
